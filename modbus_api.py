...
_REAL_RANGES: Dict[str, Tuple[float, bool, float, float]] = {
    ...
    "0x0213": (0.1,  False,      0,    120),  # grid_voltage_l1 (V)
    "0x0215": (0.01, False,      0,     65),  # grid_frequency (Hz)
    "0x0216": (0.1,  False,      0,    120),  # inverter_voltage_l1 (V)
    "0x0218": (0.01, False,      0,     65),  # inverter_frequency (Hz)
    ...
    "0x022a": (0.1,  False,      0,    120),  # grid_voltage_l2 (V)
    "0x022c": (0.1,  False,      0,    120),  # inverter_voltage_l2 (V)
